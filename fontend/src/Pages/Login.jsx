...
import { userloginInfo } from '../../slices/Userslices'; // assuming you have this slice for storing user data
  ...
  const handleLogin = (e) => {
    ...
    axios.post('http://localhost:5000/auth/login', { email, password })
      .then((response) => {
        ...
        navigate('/'); // You can modify this route based on your app's flow
      })
      .catch((error) => {
        // On login failure
